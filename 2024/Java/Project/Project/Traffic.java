...
public class Traffic {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("How many other roads are available to go to " + destination + "? ");
        ...
        System.out.println("The best road is: " + bestRoad.getName() + " with " + bestRoad.getTraffic() + " cars.");
        System.out.println("You can start your trip from " + currentLocation + " to " + destination + " using " + bestRoad.getName() + ".");
