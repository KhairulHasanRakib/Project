...
<body>
   ...
   <section class="playlist-details">
      ...
      <div class="row">
         ...
         <div class="column">
            ...
            <div class="details">
               <h3>Complete Adobe Illustrator Tutorial</h3>
   ...
   <section class="playlist-videos">
      ...
      <div class="box-container">
         <a class="box" href="../../Video/Adobe-Illustrator/">
            <i class="fas fa-play"></i>
            <img src="../../images/Adobe-Illustrator.jpg" alt="">
            <h3>Adobe Illustrator (part 01)</h3>
         </a>

         <a class="box" href="../../Video/Adobe-Illustrator/">
            <i class="fas fa-play"></i>
            <img src="../../images/Adobe-Illustrator.jpg" alt="">
            <h3>Adobe Illustrator (part 02)</h3>
         </a>

         <a class="box" href="../../Video/Adobe-Illustrator/">
            <i class="fas fa-play"></i>
            <img src="../../images/Adobe-Illustrator.jpg" alt="">
            <h3>Adobe Illustrator (part 03)</h3>
         </a>
      </div>
   </section>
