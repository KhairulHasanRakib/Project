...
<body>
   ...
   <section class="playlist-details">
      ...
      <div class="row">
         ...
         <div class="column">
            ...
            <div class="details">
               <h3>Complete Adobe Photoshop Tutorial</h3>
   ...
   <section class="playlist-videos">
      ...
      <div class="box-container">
         <a class="box" href="../../Video/Adobe-Photoshop/">
            <i class="fas fa-play"></i>
            <img src="../../images/Photoshop.jpg" alt="">
            <h3>Adobe Photoshop (part 01)</h3>
         </a>

         <a class="box" href="../../Video/Adobe-Photoshop/">
            <i class="fas fa-play"></i>
            <img src="../../images/Photoshop.jpg" alt="">
            <h3>Adobe Photoshop (part 02)</h3>
         </a>

         <a class="box" href="../../Video/Adobe-Photoshop/">
            <i class="fas fa-play"></i>
            <img src="../../images/Photoshop.jpg" alt="">
            <h3>Adobe Photoshop (part 03)</h3>
         </a>
      </div>
   </section>
