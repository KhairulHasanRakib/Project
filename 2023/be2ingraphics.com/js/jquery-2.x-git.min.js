/*! jQuery v2.2.5-pre | (c) jQuery Foundation | jquery.org/license */ ! function(a, b) {
    ...
    function ca(a, b, c, d, e) {
        for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], o = 0, p = a.length; o < p; o++)
            if (f = a[o], f || 0 === f)
    ...
    function ua(a, b, c, d) {
        ...
        if (o && (e = ca(b, a[0].ownerDocument, !1, a, d), g = e.firstChild, 1 === e.childNodes.length && (e = g), g || d)) {
            ...
            if (i)
                for (k = h[h.length - 1].ownerDocument, n.map(h, ra), m = 0; m < i; m++) j = h[m], Z.test(j.type || "") && !N.access(j, "globalEval") && n.contains(k, j) && (j.src ? n._evalUrl && n._evalUrl(j.src) : n.globalEval(j.textContent.replace(oa, "")))
        }
        return a
    }
    ...
    n.extend({
        ...
        clone: function(a, b, c) {
            ...
            if (!(l.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || n.isXMLDoc(a)))
                for (g = _(h), f = _(a), d = 0, e = f.length; d < e; d++) ta(f[d], g[d]);
            if (b)
                if (c)
                    for (f = f || _(a), g = g || _(h), d = 0, e = f.length; d < e; d++) sa(f[d], g[d]);
                else sa(a, h);
    ...
    function Pa(a, b, c) {
        ...
        if (e <= 0 || null == e) {
            if (e = Fa(a, b, f), (e < 0 || null == e) && (e = a.style[b]), Ba.test(e)) return e;
    ...
    n.extend({
        ...
        if (b) return (parseFloat(Fa(a, "marginLeft")) || a.getBoundingClientRect().left - Da(a, {
            marginLeft: 0
        }, function() {
    ...
    function Ya(a, b, c) {
        for (var d, e = (_a.tweeners[b] || []).concat(_a.tweeners["*"]), f = 0, g = e.length; f < g; f++)
    ...
    l.cors = !!Ib && "withCredentials" in Ib, l.ajax = Ib = !!Ib, n.ajaxTransport(function(b) {
        var c, d;
        if (l.cors || Ib && !b.crossDomain) return {
            send: function(e, f) {
                var g, h = b.xhr();
    ...
    n.ajaxSetup({
        ...
        if (h || "jsonp" === b.dataTypes[0]) return e = b.jsonpCallback = n.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, h ? b[h] = b[h].replace(Kb, "$1" + e) : b.jsonp !== !1 && (b.url += (lb.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), b.converters["script json"] = function() {
