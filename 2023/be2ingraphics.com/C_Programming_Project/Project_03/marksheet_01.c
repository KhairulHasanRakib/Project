...
repeate5:
    ...
    printf("\nIf you want to generate your mark sheet then press 'Y' otherwise 'N': ");
    fflush(stdin);
    scanf("%c", &yesNo);
    if (yesNo == 'y' || yesNo == 'Y')
    {
...
{
    char yesNo;
    printf("\n             **Welcome to mark sheet generation project**               \n\n");
    printf("If you want to generate your mark sheet ");
